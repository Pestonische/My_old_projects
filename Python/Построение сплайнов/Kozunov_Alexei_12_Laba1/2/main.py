...
if __name__ == '__main__':
    ...
    print("Время")
    start = time.time_ns()
    k = dotsLagranga(2, -2, 6)
    masX = [-2 + k * i for i in range(6)]
    ...
    print("Время")
    start = time.time_ns()
    k2 = dotsLagranga(2, -2, 12)
    masX2 = [-2 + k2 * i for i in range(12)]
    ...
    print("Время")
    start = time.time_ns()
    k3 = dotsLagranga(2, -2, 18)
    masX3 = [-2 + k3 * i for i in range(18)]
