...
public class Equilateral_Triangle extends Triangle implements 
...
Iterable<String>, Iterator<String>
{
  ...
  Equilateral_Triangle( String...args ){
	...
	public double Perimeter() 
	{
		...
		perimeter+=3*Double.parseDouble(this.areas[0]);
	...
	public double Area()
	{
		...
		area=Double.parseDouble(this.areas[0])*Double.parseDouble(this.areas[0])*Math.sin(3.14/3)/2;
