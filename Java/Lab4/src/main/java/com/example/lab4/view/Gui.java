...
public class Gui {
    ...
    private void rasterizeLine() {
        ...
        pane.getChildren().removeIf(node -> GridPane.getRowIndex(node) == 1 && GridPane.getColumnIndex(node) == 0);
    ...
    private void rasterizeCircle() {
        ...
        pane.getChildren().removeIf(node -> GridPane.getRowIndex(node) == 1 && GridPane.getColumnIndex(node) == 1);
