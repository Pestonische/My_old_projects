...
public class Client  implements Serializable {
    ...
    private ArrayList<AccountAbstract> listAccountsClient;// = new ArrayList<>();

    public void setListAccountsClient(ArrayList<AccountAbstract> listAccountsClient) {
    ...
    public ArrayList<AccountAbstract> getListAccountsClient() {
