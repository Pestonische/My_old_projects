...
<html>
<head>
    <title><fmt:message key="title.confirmedOrders"/></title>
...
<header>
    ...
    <h2><fmt:message key="title.confirmedOrders"/></h2>
</header>

<%--@elvariable id="confirmedOrders" type="java.util.List<org.bsu.web.lab8.model.entity.Order>"--%>
