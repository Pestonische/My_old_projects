...
public class Index implements Serializable, Closeable {
    ...
    IndexOne2One          providers;
    IndexOne2N            datas;
    IndexOne2One          age_limits;
    ...
    public void put( Business_Firm toy, long value ) throws KeyNotUniqueException {
        test( toy );
        providers.put( toy.provider, value );
        datas.put( toy.receipt_date, toy.authorDel, value);
        age_limits.put( toy.age_limit, value);		
    }
	
    public Index()  {
    	providers   = new IndexOne2One();
    	datas = new IndexOne2N();
    	age_limits 	= new IndexOne2One();
    }
